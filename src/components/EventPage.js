          ...
          <div className="conatiner_n3">
            ...
            <div className="post_r_3">
              <p className="post_date">
                ...
                <span className="date_txt">{reqdate}</span>
              </p>
              <p className="post_participants">
                <FontAwesomeIcon icon={faUser} />{" "}
                <span className="part_txt">{Participants}/100</span>
              </p>
            </div>
            {joinedStatus ? (
              <button
                className="join_btn"
                onClick={() => joinInThisEvent(PostID)}
              >
                Join Event
              </button>
            ) : (
