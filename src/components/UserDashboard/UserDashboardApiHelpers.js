...
export const getPostById = (id) => {
  return fetch(`${API}/post/${id}`).then((response) => response.json());
};
...
export const participantsofEvent = (user_id, token, post_id) => {
  return fetch(`${API}/post/participants/${user_id}/${post_id}`, {
    method: "GET",
    headers: {
      Accept: "application/json",
      Authorization: `Bearer ${token}`,
